...
def create_imbalance_data_human():
    ...
    drugs=dict()
    examples=dict()
    example_writer=open('dataset/cpi_task/human_examples_global_final_1_29.tsv','w')
...
def create_imbalance_data_drugcentral():
    ...
    drugs=dict()
    examples=dict()
    example_writer=open('dataset/dti_task/drugcentral_examples_global_final_1_29.tsv','w')
